...
//header("Content-Type: text/html; charset=UTF-8",true)
	...
	$result=mysql_query("SELECT id, mensagem, palavras, palpesca, tempo, imagem FROM gamepesca ORDER BY id;") or die(mysql_error());
	...
	$arr = array('palavra' => $palavra, 'pImagem' => $pImagem, 'informacao' => $pInformacao, 'pTotal' => $palPesca, 'tempo' => $tempo, 'score' => $score, 'nivel' => $nivel);
	?> <!doctype html> <html lang="en"> <head> <meta charset="utf-8"> <title>EduPesca | Aprendizado Online</title> <meta name="description" content="Desenvolvemos websites interativo e jogável."> <meta name="author" content="Israel Gonçalves, Gabriel Teles, Aprendizado Online"> <meta name="viewport" content="width=device-width,initial-scale=1"> <link rel="stylesheet" type="text/css" href="css/style.css"/> <script src="libs/Box2dWeb-2.1.a.4.js">
/********************************************************************/
/*                                                                  */
...
/********************************************************************/
 ...
 </script> <script src="libs/crafty.js">
/********************************************************************/
/*                                                                  */
/*  Copyright (c) 2014 Genesis Mobile                               */
/*                                                                  */
...
/********************************************************************/
 ...
 </script> <script src="libs/jquery-1.7.2.min.js" charset="utf-8">
/********************************************************************/
/*                                                                  */
/*  Copyright (c) 2014 Genesis Mobile                               */
/*                                                                  */
...
/********************************************************************/
 ...
 </script> <script src="libs/jquery.lettering.js">
/********************************************************************/
/*                                                                  */
/*  Copyright (c) 2014 Genesis Mobile                               */
/*                                                                  */
...
/********************************************************************/
 ...
 </script> <script src="libs/underscore-min.js">
/********************************************************************/
/*                                                                  */
/*  Copyright (c) 2014 Genesis Mobile                               */
/*                                                                  */
...
/********************************************************************/
 ...
 </script> <script src="libs/box2d.js">
/********************************************************************/
/*                                                                  */
/*  Copyright (c) 2014 Genesis Mobile                               */
/*                                                                  */
...
/********************************************************************/
 ...
 </script> <script src="libs/kdtreeCrafty.js">
/********************************************************************/
/*                                                                  */
/*  Copyright (c) 2014 Genesis Mobile                               */
/*                                                                  */
