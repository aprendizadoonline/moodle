...
class mod_video_mod_form extends moodleform_mod {
    function definition() {
        ...
        $script = '<script type="text/javascript">
          ...
          {
            document.write(\'<script src="' .  $config->url . 'js/jquery.min.js" type="text/javascript"><\/script>\');
          }
        </script>
        <script src="' .  $config->url . 'js/videoteca.plugin-v2.js" type="text/javascript"></script>
        <link href="' . $config->url . 'css/moodle-v2.css"   rel="stylesheet" type="text/css" media="all" />';
        $mform->addElement('html', $script);
        
        // $mform->addElement('html', '<script src="' .  $config->url . 'js/jquery.min.js" type="text/javascript"></script>');
		// $mform->addElement('html', '<script src="' .  $config->url . 'js/videoteca.plugin.js" type="text/javascript"></script>');
        ...
        $mform->addElement('text', 'externalvideo', get_string('externalvideo', 'video'), array('size'=>'60'), array('usefilepicker'=>true));
    ...
    function validation($data, $files) {
        ...
        // Validating Entered video, we are looking for obvious problems only,
        ...
        // NOTE: do not try to explain the difference between video and URI, people would be only confused...
